        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Hi, [Doctor]</h4>
                    {{-- Keep in mind na lahat ng may brackets ay placeholder lang.. 
                    dapat ang replacement jan is yung name nung doctor talaga
                    same with every other place na may brackets, respective of the data na
                    dapat nandon --}}
